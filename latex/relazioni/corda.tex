...
\\
Utilizziamo il metodo dei minimi quadrati, ottenendo per la\textbf{ corda A}: $m_A = 403.95$ con incertezza $\sigma_m =0.03$;  per la \textbf{corda B}: $m_B=143.0$ con incertezza $\sigma_m$.  Di seguito il grafico che rappresenta la relazione tra $\nu^2$ e $T$.
