...
La forzante è data da un oscillatore elettromeccanico, mentre la tensione è esercitata da pesetti appesi all'estremità libera della corda, sospesi attraverso una carrucola. 
...
Dall'equazione \ref{frequenza} si deduce la dipendenza quadratica tra la tensione $T$ e la frequenza $\nu$. 
...
\begin{center}
\includegraphics[scale=0.7]{../grafici/corda_tensione}
\end{center}
 


\section{Dipendenza dalla lunghezza}
L'ultima analisi riguarda la dipendeza di $\nu_n$ dalla lunghezza della corda, per una data tensione fissata. Essa è ancora una conseguenza della \ref{frequenza}, dalla quale si deduce che le due grandezze sono legate da proporzionalità inversa.\\
...
Ci limitiamo a rappresentare nel grafico seguente il comportamento della corda B, di cui si sono raccolti più valori.
