...
Essendo il numero dei dati troppo ridotto per essere interpolato con successo dalla curva corrispondente ($1.1$), consideriamo un'interpolazione lineare di tipo $y = Ax$ dove   $y= \nu^2$ e $x = \tau$.
\\
Utilizziamo il metodo dei minimi quadrati, ottenendo $A = $ con incertezza $\sigma_A =$. Di seguito il grafico che rappresenta la relazione tra $\nu^2$ e $\tau$.
