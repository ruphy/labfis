...
Nella prima, si verifica la validità della Legge di Snell (vedi contenuti teorici) e la reversibilità del cammino luminoso, tramite varie  misure dell'angolo di rifrazione $\theta_{rifrazione}$ per un angolo $\theta_{incidenza} $ di incidenza,per un raggio luminoso attraversante un semi-cilindro in plexiglass. Si ricerca la miglior stima dell'indice di rifrazione del plexiglass.
Nella seconda parte, si ricerca l'indice di rifrazione del plexiglass studiando l'angolo di deviazione minima di un prisma a base triangolare e di un prisma a base trapezoidale.(vedi contenuti teorici per spiegazione). 
Inoltre, si ricerchi la distanza di cui viene traslato il raggio quando passa per due superfici parallele con un certo angolo  $\theta $ di incidenza.
Nell'ultima parte, si verifica la legge dei punti coniugati tramite la misura delle distanze p e q e la validità dell'ingrandimento ottico M. 
...
L'esperimento si è svolto su una rotaia, che permetteva di spostare la piattaforma rotante. 
