...
\subsubsection{Dati geometrici fili A,B,C}
...
\subsection{FASE 1: Misura dei momenti d'inerzia}
...
Per procedere a ricavare sperimentalmente il momento d'inerzia di questi corpi, si è utilizzato un sistema di due pulleggie e un sensore di rotazione.
...
\subsection{FASE 2: Pendolo di torsione}
...
\subsection{FASE 3: Misura di equilibrio}
...
\subsection{FASE A: Misura dei momenti d'inerzia}
...
\subsection{FASE B: Pendolo di torsione}
