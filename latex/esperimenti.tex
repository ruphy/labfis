...
Il valore così calcolato è leggermente maggiore di quello ricavato dalla misurazione diretta. $$\omega_{interpolato} =  4.275 rad/s$$
$$\omega_{misurato} = 4.272 rad/s$$

Questi due risultati sono in perfetto accordo nei limiti della precisione dello strumento.
...
L'oscillatore smorzato e sforzato fornisce il risultato\\

\begin{tabular}{l|l}
$\omega$ (rad/s) & Ampiezza (rad) \\
\midrule
1.15	& 0.89\\
1.31	& 0.94\\
1.75	& 1.05\\
