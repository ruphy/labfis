...
Durante l'esecuzione dell'esperimento ci si è serviti di un proiettore con diversi tipi di sorgente luminosa. Durante l'esperimento è stato impostato sulla modalità a singolo raggio luminoso per le prime due parti e successivamente sulla modalità oggetto per la terza e ultima parte. 
...
Tutte le misure seguenti sono in Gradi.\\
\begin{center}
...
Posto $n_a \simeq1 $ ( indice di rifrazione dell'aria ), si ricava:
