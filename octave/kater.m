...
# 13.5 cm dal primo coltello
t1 = [2.0013 2.0029 2.0021 2.0042 2.0026 2.0012 2.0014 2.0008 2.0036 2.0005];
t2 = [1.9983 1.9983 1.9967 1.9978 1.9978 1.9986 1.9986 1.9988 2.0001 1.9994];

gauss_analysis("13.5 cm dal 1 - 1", 0.001, t1);
gauss_analysis("13.5 cm dal 1 - 2", 0.001, t2);
